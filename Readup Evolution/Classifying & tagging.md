Readup already supports the parsing of topics and tags defined by the publisher on articles (see [[Followable topics]]), but the user can not add tags to articles that they define.
