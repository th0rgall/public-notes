...
*Disclaimer: YMMV. If your have different information about older or newer Kindles, let me know!*

## Introduction

**The web browser on my 2015 Kindle Paperwhite seems like an absolute afterthought**. It mostly just doesn't work for the web of today, and I doubt it ever has. 
...
My Kindle also has great assets that remain relevant today:
...
- It's user agent is:
	...
	```
- The above agent suggests a WebKit version of 531.2 - 533.2.
- This corresponds to WebKit versions used in **Safari 4**, released for Mac OS X Tiger in **the summer of 2009** ([Wikipedia](https://en.wikipedia.org/wiki/Safari_version_history#Safari_4)). It is a useful reference point to look up in MDN/CanIUse "Browser Compatibility" tables, because WebKit versions are generally not mentioned in compatibility tables, but Safari versions are.
...
Here is what I still want to test [[Kindle Browser benchmarking to-do]]